...
CC = /usr/local/i386-pc-elf/bin/i386-pc-elf-gcc
AS = /usr/local/i386-pc-elf/bin/i386-pc-elf-gcc
LD = /usr/local/i386-pc-elf/bin/i386-pc-elf-ld
OBJCOPY = /usr/local/i386-pc-elf/bin/i386-pc-elf-objcopy
